...
export interface ConfirmOptions {
  ...
  // staged one) where red would overstate the risk. Matches confirm.js's
  // own opts.danger.
  danger?: boolean
}
...
// Ported from app/static/confirm.js's window.PostWardenConfirm.ask(): same
// true/false Promise shape as the native confirm() it replaces, just
// asynchronous — awaiting a click instead of blocking the whole page. See
// ConfirmDialog.tsx's own file comment for the full port writeup.
