...
| [`ARCHITECTURE.md`](ARCHITECTURE.md) | *How* is the app code organized? | You're adding a backend route or a frontend screen, and want to match the existing conventions instead of inventing new ones. |
